...
const NewsCard: React.FC<NewsCardProps> = ({
  ...
  // Image URL - Images are generated by Gemini 3 Pro Image Preview and stored in Supabase Storage
  // Only use article.imageUrl from the database, no external fallbacks
